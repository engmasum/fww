...
if($form=="listing_update"){
    ...
    $sql=mysqli_query($conn,"UPDATE db_listing SET 
        ...
        facebook_id='$list_facebook',
        list_description='$list_description',
        company_logo='$veryfinalfile',
        list_hour_mon='$list_hour_mon',
        list_hour_tue='$list_hour_tue',
        list_hour_wed='$list_hour_wed',
        list_hour_thu='$list_hour_thu',
        list_hour_fri='$list_hour_fri',
        list_hour_sat='$list_hour_sat',
        list_hour_sun='$list_hour_sun',
        list_amen_wifi='$list_amen_wifi',
        list_amen_parking='$list_amen_parking',
        list_amen_takeaway='$list_amen_takeaway',
        list_amen_smoking='$list_amen_smoking',
        list_amen_nonsmoking='$list_amen_nonsmoking',
        list_amen_reservation='$list_amen_reservation',
        list_amen_halal='$list_amen_halal',
        list_amen_nonhalal='$list_amen_nonhalal',
        list_amen_nopork='$list_amen_nopork',
        list_amen_vegeterian='$list_amen_vegeterian' 
        WHERE submission_list_id=$id ");
        echo"Submission List Update Successfully.. ";
        ?>
        <script> window.locaton="?page=admin-listing-row";</script>
        <?php
    }else{ 

                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="page-title">
                                <center><h1>Submission Lists Table </h1></center>
                            </div><!-- /.page-title -->

                            <div class="background-white p20 mb50">
                                <h3 class="page-title">View the listing </h3>
                                ...
                                <tr>
                                    ...
                                    <th>
                                     <a href="/?page=listing-update&id=<?=$row['submission_list_id']?>">   <button class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit</button></a>
                                    <a href="?page=listing-delete&id=<?=$row['submission_list_id']?>"><button class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete</button></a>
                                    </th>
                                </tr>
                                <?}?>
